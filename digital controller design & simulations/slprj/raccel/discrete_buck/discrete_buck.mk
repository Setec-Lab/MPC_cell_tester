...
MODEL               = discrete_buck
MODULES             = rt_logging.c discrete_buck.c discrete_buck_capi.c discrete_buck_data.c discrete_buck_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
MAKEFILE            = discrete_buck.mk
MATLAB_ROOT         = C:/Program Files/Polyspace/R2019a
ALT_MATLAB_ROOT     = C:/PROGRA~1/Polyspace/R2019a
MATLAB_BIN          = C:/Program Files/Polyspace/R2019a/bin
ALT_MATLAB_BIN      = C:/PROGRA~1/Polyspace/R2019a/bin
MASTER_ANCHOR_DIR   = 
START_DIR           = C:/Users/kagom/OneDrive/Entrenamiento Académico/TEC/SETEC Lab/Trabajo final de graduación 2022/TFG_KevinGomez/digital controller design & simulations
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/discrete_buck \
...
%.obj : $(START_DIR)/slprj/raccel/discrete_buck/%.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
...
rt_logging.obj : C:\Program\ Files\Polyspace\R2019a\rtw\c\src/rt_logging.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019a\rtw\c\src/rt_logging.c

raccel_main_new.obj : C:\Program\ Files\Polyspace\R2019a\rtw\c\raccel/raccel_main_new.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019a\rtw\c\raccel/raccel_main_new.c

raccel_sup.obj : C:\Program\ Files\Polyspace\R2019a\rtw\c\raccel/raccel_sup.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019a\rtw\c\raccel/raccel_sup.c

raccel_mat.obj : C:\Program\ Files\Polyspace\R2019a\rtw\c\raccel/raccel_mat.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019a\rtw\c\raccel/raccel_mat.c

simulink_solver_api.obj : C:\Program\ Files\Polyspace\R2019a\simulink\include/simulink_solver_api.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019a\simulink\include/simulink_solver_api.c

raccel_utils.obj : C:\Program\ Files\Polyspace\R2019a\rtw\c\src\rapid/raccel_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019a\rtw\c\src\rapid/raccel_utils.c

common_utils.obj : C:\Program\ Files\Polyspace\R2019a\rtw\c\src\rapid/common_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019a\rtw\c\src\rapid/common_utils.c

ext_svr.obj : C:\Program\ Files\Polyspace\R2019a\rtw\c\src\ext_mode\common/ext_svr.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019a\rtw\c\src\ext_mode\common/ext_svr.c

updown.obj : C:\Program\ Files\Polyspace\R2019a\rtw\c\src\ext_mode\common/updown.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019a\rtw\c\src\ext_mode\common/updown.c

ext_work.obj : C:\Program\ Files\Polyspace\R2019a\rtw\c\src\ext_mode\common/ext_work.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019a\rtw\c\src\ext_mode\common/ext_work.c

rtiostream_interface.obj : C:\Program\ Files\Polyspace\R2019a\rtw\c\src\ext_mode\common/rtiostream_interface.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019a\rtw\c\src\ext_mode\common/rtiostream_interface.c

rtiostream_tcpip.obj : C:\Program\ Files\Polyspace\R2019a\toolbox\coder\rtiostream\src\rtiostreamtcpip/rtiostream_tcpip.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019a\toolbox\coder\rtiostream\src\rtiostreamtcpip/rtiostream_tcpip.c

rtiostream_utils.obj : C:\Program\ Files\Polyspace\R2019a\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019a\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
...
%.obj : $(START_DIR)/slprj/raccel/discrete_buck/%.cpp
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
