...
"slprj\\raccel\\discrete_buck\\discrete_buck_Jpattern.mat" ; const int_T
...
model_S ; void MdlInitialize ( void ) { rtDW . h5dc1rpojv [ 0 ] = rtP .
DiscreteTransferFcn_InitialStates ; rtDW . h5dc1rpojv [ 1 ] = rtP .
DiscreteTransferFcn_InitialStates ; rtDW . ln3jvbo3qx = rtP .
Delay_InitialCondition ; rtDW . nqmsf5lihu = rtP . Delay1_InitialCondition ;
...
( int_T tid ) { if ( ssIsSampleHit ( rtS , 1 , 0 ) ) { rtB . bkyphiynml = rtP
. DiscreteTransferFcn_NumCoef [ 0 ] * rtDW . h5dc1rpojv [ 0 ] + rtP .
DiscreteTransferFcn_NumCoef [ 1 ] * rtDW . h5dc1rpojv [ 1 ] ; rtB .
h4ggnwv2is = rtP . Constant_Value - rtP . Gain_Gain * rtB . bkyphiynml ; rtB
. ehcp4ye11o = rtP . Gain_Gain_av4lqwgh23 * rtB . h4ggnwv2is + rtDW .
ln3jvbo3qx ; rtB . ekfyt1ufxk = ( rtP . Gain1_Gain * rtB . h4ggnwv2is + rtB .
ehcp4ye11o ) + ( rtB . h4ggnwv2is - rtDW . nqmsf5lihu ) * rtP . Gain2_Gain ;
} UNUSED_PARAMETER ( tid ) ; } void MdlUpdate ( int_T tid ) { real_T denAccum
; if ( ssIsSampleHit ( rtS , 1 , 0 ) ) { denAccum = ( ( rtB . ekfyt1ufxk -
rtP . DiscreteTransferFcn_DenCoef [ 1 ] * rtDW . h5dc1rpojv [ 0 ] ) - rtP .
DiscreteTransferFcn_DenCoef [ 2 ] * rtDW . h5dc1rpojv [ 1 ] ) / rtP .
DiscreteTransferFcn_DenCoef [ 0 ] ; rtDW . h5dc1rpojv [ 1 ] = rtDW .
h5dc1rpojv [ 0 ] ; rtDW . h5dc1rpojv [ 0 ] = denAccum ; rtDW . ln3jvbo3qx =
rtB . ehcp4ye11o ; rtDW . nqmsf5lihu = rtB . h4ggnwv2is ; } UNUSED_PARAMETER
...
ssSetNumSampleTimes ( rtS , 2 ) ; ssSetNumBlocks ( rtS , 15 ) ;
ssSetNumBlockIO ( rtS , 4 ) ; ssSetNumBlockParams ( rtS , 15 ) ; } void
MdlInitializeSampleTimes ( void ) { ssSetSampleTime ( rtS , 0 , 0.0 ) ;
ssSetSampleTime ( rtS , 1 , 0.4 ) ; ssSetOffsetTime ( rtS , 0 , 1.0 ) ;
ssSetOffsetTime ( rtS , 1 , 0.0 ) ; } void raccel_set_checksum ( ) {
ssSetChecksumVal ( rtS , 0 , 4120331180U ) ; ssSetChecksumVal ( rtS , 1 ,
2148891758U ) ; ssSetChecksumVal ( rtS , 2 , 1729628525U ) ; ssSetChecksumVal
( rtS , 3 , 491399547U ) ; }
#if defined(_MSC_VER)
#pragma optimize( "", off )
#endif
...
discrete_buck_InitializeDataMapInfo ( ) ; ssSetIsRapidAcceleratorActive ( rtS
, true ) ; ssSetRootSS ( rtS , rtS ) ; ssSetVersion ( rtS ,
SIMSTRUCT_VERSION_LEVEL2 ) ; ssSetModelName ( rtS , "discrete_buck" ) ;
ssSetPath ( rtS , "discrete_buck" ) ; ssSetTStart ( rtS , 0.0 ) ; ssSetTFinal
...
4120331180U ) ; ssSetChecksumVal ( rtS , 1 , 2148891758U ) ; ssSetChecksumVal
( rtS , 2 , 1729628525U ) ; ssSetChecksumVal ( rtS , 3 , 491399547U ) ; {
